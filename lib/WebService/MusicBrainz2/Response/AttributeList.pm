package WebService::MusicBrainz2::Response::AttributeList;
...
WebService::MusicBrainz2::Response::AttributeList
...
__PACKAGE__->mk_accessors(qw/attributes count offset/);
