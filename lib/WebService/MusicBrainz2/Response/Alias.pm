package WebService::MusicBrainz2::Response::Alias;
...
WebService::MusicBrainz2::Response::Alias
...
__PACKAGE__->mk_accessors(qw/type script text primary sort_name locale/);
