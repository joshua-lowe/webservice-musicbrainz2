package WebService::MusicBrainz2::Response::CoverArtArchive;
...
WebService::MusicBrainz2::Response::CoverArtArchive
...
__PACKAGE__->mk_accessors(qw/artwork count front back/);
