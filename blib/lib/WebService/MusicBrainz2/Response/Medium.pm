package WebService::MusicBrainz2::Response::Medium;
...
WebService::MusicBrainz2::Response::Medium
...
__PACKAGE__->mk_accessors(qw/position format disc_list track_list/);
