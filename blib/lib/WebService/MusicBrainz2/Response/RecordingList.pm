package WebService::MusicBrainz2::Response::RecordingList;
...
WebService::MusicBrainz2::Response::RecordingList
...
__PACKAGE__->mk_accessors(qw/recordings count offset/);
