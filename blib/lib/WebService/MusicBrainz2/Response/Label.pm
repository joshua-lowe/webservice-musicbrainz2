package WebService::MusicBrainz2::Response::Label;
...
WebService::MusicBrainz2::Response::Label
...
__PACKAGE__->mk_accessors(
	qw/id type name sort_name label_code disambiguation country 
	life_span alias_list release_list relation_list relation_lists
