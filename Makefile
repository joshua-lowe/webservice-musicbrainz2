...
LDDLFLAGS = -shared -march=nocona -O2 -pipe -Wl,-O1 -Wl,--as-needed
LDFLAGS = -Wl,-O1 -Wl,--as-needed
LIBC = /lib/libc-2.15.so
LIB_EXT = .a
OBJ_EXT = .o
OSNAME = linux
OSVERS = 3.8.0-gentoo
...
DIRFILESEP = /
DFSEP = $(DIRFILESEP)
NAME = WebService::MusicBrainz2
NAME_SYM = WebService_MusicBrainz2
VERSION = 0.23
...
MAKE = make
FULLEXT = WebService/MusicBrainz2
BASEEXT = MusicBrainz2
PARENT_NAME = WebService
DLBASE = $(BASEEXT)
VERSION_FROM = lib/WebService/MusicBrainz2.pm
OBJECT = 
LDFROM = $(OBJECT)
LINKTYPE = dynamic
BOOTDEP = 
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/WebService/MusicBrainz2.pm \
	lib/WebService/MusicBrainz2/Artist.pm \
	lib/WebService/MusicBrainz2/Label.pm \
	lib/WebService/MusicBrainz2/Query.pm \
	lib/WebService/MusicBrainz2/Recording.pm \
	lib/WebService/MusicBrainz2/Release.pm \
	lib/WebService/MusicBrainz2/ReleaseGroup.pm \
	lib/WebService/MusicBrainz2/Response.pm \
	lib/WebService/MusicBrainz2/Response/Alias.pm \
	...
	lib/WebService/MusicBrainz2/Response/Recording.pm \
	lib/WebService/MusicBrainz2/Response/RecordingList.pm \
	lib/WebService/MusicBrainz2/Response/Relation.pm \
	lib/WebService/MusicBrainz2/Response/RelationList.pm \
	lib/WebService/MusicBrainz2/Response/Release.pm \
	...
	lib/WebService/MusicBrainz2/Response/ReleaseGroupList.pm \
	...
	lib/WebService/MusicBrainz2/Response/UserRating.pm \
...
TO_INST_PM = lib/WebService/MusicBrainz2.pm \
	lib/WebService/MusicBrainz2/Artist.pm \
	lib/WebService/MusicBrainz2/Label.pm \
	lib/WebService/MusicBrainz2/Query.pm \
	lib/WebService/MusicBrainz2/Recording.pm \
...
PM_TO_BLIB = lib/WebService/MusicBrainz2/Response/Rating.pm \
	blib/lib/WebService/MusicBrainz2/Response/Rating.pm \
	lib/WebService/MusicBrainz2/Recording.pm \
	blib/lib/WebService/MusicBrainz2/Recording.pm \
	lib/WebService/MusicBrainz2/Response/Label.pm \
	blib/lib/WebService/MusicBrainz2/Response/Label.pm \
	lib/WebService/MusicBrainz2/Response/UserTag.pm \
	...
	lib/WebService/MusicBrainz2/Response/LabelInfoList.pm \
	blib/lib/WebService/MusicBrainz2/Response/LabelInfoList.pm \
	lib/WebService/MusicBrainz2/Response/LabelList.pm \
	blib/lib/WebService/MusicBrainz2/Response/LabelList.pm \
	lib/WebService/MusicBrainz2/Response/ReleaseGroupList.pm \
	blib/lib/WebService/MusicBrainz2/Response/ReleaseGroupList.pm \
	lib/WebService/MusicBrainz2/Response.pm \
	blib/lib/WebService/MusicBrainz2/Response.pm \
	lib/WebService/MusicBrainz2/Response/Release.pm \
	blib/lib/WebService/MusicBrainz2/Response/Release.pm \
	lib/WebService/MusicBrainz2/Response/UserRating.pm \
	blib/lib/WebService/MusicBrainz2/Response/UserRating.pm \
	lib/WebService/MusicBrainz2/Response/MediumList.pm \
	blib/lib/WebService/MusicBrainz2/Response/MediumList.pm \
	lib/WebService/MusicBrainz2/Artist.pm \
	blib/lib/WebService/MusicBrainz2/Artist.pm \
	lib/WebService/MusicBrainz2/Response/PuidList.pm \
	blib/lib/WebService/MusicBrainz2/Response/PuidList.pm \
	lib/WebService/MusicBrainz2/Response/Disc.pm \
	blib/lib/WebService/MusicBrainz2/Response/Disc.pm \
	lib/WebService/MusicBrainz2/Response/Puid.pm \
	blib/lib/WebService/MusicBrainz2/Response/Puid.pm \
	lib/WebService/MusicBrainz2/Response/Recording.pm \
	blib/lib/WebService/MusicBrainz2/Response/Recording.pm \
	lib/WebService/MusicBrainz2/Response/Alias.pm \
	blib/lib/WebService/MusicBrainz2/Response/Alias.pm \
	lib/WebService/MusicBrainz2/Response/DiscList.pm \
	blib/lib/WebService/MusicBrainz2/Response/DiscList.pm \
	lib/WebService/MusicBrainz2/Response/Ipi.pm \
	blib/lib/WebService/MusicBrainz2/Response/Ipi.pm \
	lib/WebService/MusicBrainz2/Response/TagList.pm \
	...
	lib/WebService/MusicBrainz2/Response/WorkList.pm \
	blib/lib/WebService/MusicBrainz2/Response/WorkList.pm \
	lib/WebService/MusicBrainz2/Response/ISRC.pm \
	blib/lib/WebService/MusicBrainz2/Response/ISRC.pm \
	lib/WebService/MusicBrainz2/Query.pm \
	blib/lib/WebService/MusicBrainz2/Query.pm \
	lib/WebService/MusicBrainz2/Response/Metadata.pm \
	blib/lib/WebService/MusicBrainz2/Response/Metadata.pm \
	lib/WebService/MusicBrainz2/Release.pm \
	...
	lib/WebService/MusicBrainz2/Response/ReleaseList.pm \
	blib/lib/WebService/MusicBrainz2/Response/ReleaseList.pm \
	lib/WebService/MusicBrainz2/Response/LabelInfo.pm \
	...
	lib/WebService/MusicBrainz2/Response/IpiList.pm \
	blib/lib/WebService/MusicBrainz2/Response/IpiList.pm \
	lib/WebService/MusicBrainz2/Work.pm \
	...
	lib/WebService/MusicBrainz2/Response/Artist.pm \
	blib/lib/WebService/MusicBrainz2/Response/Artist.pm \
	lib/WebService/MusicBrainz2/Response/ArtistCredit.pm \
	blib/lib/WebService/MusicBrainz2/Response/ArtistCredit.pm \
	lib/WebService/MusicBrainz2/Label.pm \
	blib/lib/WebService/MusicBrainz2/Label.pm \
	lib/WebService/MusicBrainz2/Response/Relation.pm \
	blib/lib/WebService/MusicBrainz2/Response/Relation.pm \
	lib/WebService/MusicBrainz2/Response/RelationList.pm \
	blib/lib/WebService/MusicBrainz2/Response/RelationList.pm
...
DISTNAME = WebService-MusicBrainz2
DISTVNAME = WebService-MusicBrainz2-0.23
...
manifypods : pure_all  \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/WebService/MusicBrainz2/Response/Rating.pm $(INST_MAN3DIR)/WebService::MusicBrainz2::Response::Rating.$(MAN3EXT) \
	  lib/WebService/MusicBrainz2/Recording.pm $(INST_MAN3DIR)/WebService::MusicBrainz2::Recording.$(MAN3EXT) \
	  ...
	  lib/WebService/MusicBrainz2/Response/ReleaseGroupList.pm $(INST_MAN3DIR)/WebService::MusicBrainz2::Response::ReleaseGroupList.$(MAN3EXT) \
	  lib/WebService/MusicBrainz2/Response.pm $(INST_MAN3DIR)/WebService::MusicBrainz2::Response.$(MAN3EXT) \
	  lib/WebService/MusicBrainz2/Response/Release.pm $(INST_MAN3DIR)/WebService::MusicBrainz2::Response::Release.$(MAN3EXT) \
	  lib/WebService/MusicBrainz2/Response/UserRating.pm $(INST_MAN3DIR)/WebService::MusicBrainz2::Response::UserRating.$(MAN3EXT) \
	  lib/WebService/MusicBrainz2/Response/MediumList.pm $(INST_MAN3DIR)/WebService::MusicBrainz2::Response::MediumList.$(MAN3EXT) \
	  lib/WebService/MusicBrainz2/Artist.pm $(INST_MAN3DIR)/WebService::MusicBrainz2::Artist.$(MAN3EXT) \
	  lib/WebService/MusicBrainz2/Response/PuidList.pm $(INST_MAN3DIR)/WebService::MusicBrainz2::Response::PuidList.$(MAN3EXT) \
	  lib/WebService/MusicBrainz2/Response/Disc.pm $(INST_MAN3DIR)/WebService::MusicBrainz2::Response::Disc.$(MAN3EXT) \
	  lib/WebService/MusicBrainz2/Response/Puid.pm $(INST_MAN3DIR)/WebService::MusicBrainz2::Response::Puid.$(MAN3EXT) \
	  lib/WebService/MusicBrainz2/Response/Recording.pm $(INST_MAN3DIR)/WebService::MusicBrainz2::Response::Recording.$(MAN3EXT) \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  ...
	  lib/WebService/MusicBrainz2/Query.pm $(INST_MAN3DIR)/WebService::MusicBrainz2::Query.$(MAN3EXT) \
	...
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  ...
	  lib/WebService/MusicBrainz2/Response/Relation.pm $(INST_MAN3DIR)/WebService::MusicBrainz2::Response::Relation.$(MAN3EXT) \
	  lib/WebService/MusicBrainz2/Response/RelationList.pm $(INST_MAN3DIR)/WebService::MusicBrainz2::Response::RelationList.$(MAN3EXT) 
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name: WebService-MusicBrainz2' >> META_new.yml
	$(NOECHO) $(ECHO) 'no_index:' >> META_new.yml
	$(NOECHO) $(ECHO) '  directory:' >> META_new.yml
	$(NOECHO) $(ECHO) '    - t' >> META_new.yml
	$(NOECHO) $(ECHO) '    - inc' >> META_new.yml
	$(NOECHO) $(ECHO) 'requires:' >> META_new.yml
	$(NOECHO) $(ECHO) '  Class::Accessor: 0.30' >> META_new.yml
	$(NOECHO) $(ECHO) '  LWP::UserAgent: 2.0' >> META_new.yml
	$(NOECHO) $(ECHO) '  Test::More: 0.88' >> META_new.yml
	$(NOECHO) $(ECHO) '  URI: 1.35' >> META_new.yml
	$(NOECHO) $(ECHO) '  XML::LibXML: 1.63' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '   },' >> META_new.json
	$(NOECHO) $(ECHO) '   "name" : "WebService-MusicBrainz2",' >> META_new.json
	...
	$(NOECHO) $(ECHO) '         "requires" : {' >> META_new.json
	$(NOECHO) $(ECHO) '            "Class::Accessor" : "0.30",' >> META_new.json
	$(NOECHO) $(ECHO) '            "LWP::UserAgent" : "2.0",' >> META_new.json
	$(NOECHO) $(ECHO) '            "Test::More" : "0.88",' >> META_new.json
	$(NOECHO) $(ECHO) '            "URI" : "1.35",' >> META_new.json
	$(NOECHO) $(ECHO) '            "XML::LibXML" : "1.63"' >> META_new.json
	$(NOECHO) $(ECHO) '         }' >> META_new.json
	$(NOECHO) $(ECHO) '      }' >> META_new.json
	$(NOECHO) $(ECHO) '   },' >> META_new.json
...
ppd :
	...
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Class::Accessor" VERSION="0.3" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="LWP::UserAgent" VERSION="2" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Test::More" VERSION="0.88" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="URI::" VERSION="1.35" />' >> $(DISTNAME).ppd
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="XML::LibXML" VERSION="1.63" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/WebService/MusicBrainz2/Response/Rating.pm blib/lib/WebService/MusicBrainz2/Response/Rating.pm \
	  lib/WebService/MusicBrainz2/Recording.pm blib/lib/WebService/MusicBrainz2/Recording.pm \
	  ...
	  lib/WebService/MusicBrainz2/Response/ReleaseGroupList.pm blib/lib/WebService/MusicBrainz2/Response/ReleaseGroupList.pm \
	  lib/WebService/MusicBrainz2/Response.pm blib/lib/WebService/MusicBrainz2/Response.pm \
	  lib/WebService/MusicBrainz2/Response/Release.pm blib/lib/WebService/MusicBrainz2/Response/Release.pm \
	  lib/WebService/MusicBrainz2/Response/UserRating.pm blib/lib/WebService/MusicBrainz2/Response/UserRating.pm \
	  lib/WebService/MusicBrainz2/Response/MediumList.pm blib/lib/WebService/MusicBrainz2/Response/MediumList.pm \
	  lib/WebService/MusicBrainz2/Artist.pm blib/lib/WebService/MusicBrainz2/Artist.pm \
	  lib/WebService/MusicBrainz2/Response/PuidList.pm blib/lib/WebService/MusicBrainz2/Response/PuidList.pm \
	  lib/WebService/MusicBrainz2/Response/Disc.pm blib/lib/WebService/MusicBrainz2/Response/Disc.pm \
	  lib/WebService/MusicBrainz2/Response/Puid.pm blib/lib/WebService/MusicBrainz2/Response/Puid.pm \
	  lib/WebService/MusicBrainz2/Response/Recording.pm blib/lib/WebService/MusicBrainz2/Response/Recording.pm \
	  lib/WebService/MusicBrainz2/Response/Alias.pm blib/lib/WebService/MusicBrainz2/Response/Alias.pm \
	  lib/WebService/MusicBrainz2/Response/DiscList.pm blib/lib/WebService/MusicBrainz2/Response/DiscList.pm \
	...
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  ...
	  lib/WebService/MusicBrainz2/Query.pm blib/lib/WebService/MusicBrainz2/Query.pm \
